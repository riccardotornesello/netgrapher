...
export function InputBlock() {
  ...
  const formattedShape = is3D ? `[ ${c}, ${d}, ${h}, ${w} ]` : `[ ${c}, ${h}, ${w} ]`;
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 select-none">
          <div className="flex items-center gap-3">
            <div className={cn("p-1.5 rounded-md bg-zinc-800 shrink-0 transition-colors", isSelected ? "text-cyan-400" : "text-zinc-400 group-hover/input:text-zinc-200")}>
              <Database className={cn("w-4 h-4", isSelected && "animate-pulse")} />
            </div>
            <div>
