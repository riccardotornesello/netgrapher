...
export const info: LayerDescription = {
  ...
  category: 'Activation',
  concept: 'A probabilistic activation function that weights inputs by their value cumulative probability under a normal distribution. It scales input signals smoothly and is widely used in modern language models (BERT, GPT, Transformers).',
  keyTakeaways: [
  ...
  proTips: 'GELU is the standard choice in modern, high-performance Transformer systems (like BERT, ViT, and GPT). If you are building a Transformer or a heavy multimodal encoder, GELU is highly likely to outperform ReLU.',
  forwardEquation: 'f(x) = x \\cdot \\Phi(x) = x \\cdot P(X \\le x) \\approx 0.5x \\left(1 + \\tanh\\left[\\sqrt{\\frac{2}{\\pi}} (x + 0.044715 x^3)\\right]\\right)',
