...
export const info: LayerDescription = {
  ...
  category: 'Activation',
  concept: 'An element-wise activation function that squashes real-valued inputs into a smooth, probability-like range between 0 and 1. Heavily used as the final layer for binary classification tasks.',
  keyTakeaways: [
  ...
  proTips: 'Avoid Sigmoid in hidden layers of deep networks. The gradient vanishes rapidly after just a few layers. Prefer ReLU, Leaky ReLU, or GELU instead, reserving Sigmoid strictly for final binary output units.',
  ...
  flopFormula: '\\text{FLOPs} = 4 \\cdot C_{in} \\cdot H_{in} \\cdot W_{in} \\quad (\\text{Exponential arithmetic operations per element})',
