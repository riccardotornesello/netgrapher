...
export const ActivationSimulator = ({
  type,
  name,
}: {
  type: string;
    ...
    <div className="w-full flex flex-col lg:flex-row gap-8 items-center animate-in fade-in duration-300">
      <div className="flex-1 flex flex-col gap-4">
        ...
        <p className="text-[11.5px] leading-relaxed text-zinc-400">
          Input raw values entering neural connections fluctuate randomly
          between negative and positive territory. Drag the slider to observe
          how the {name} curve transforms values:
        </p>
        ...
        <div className="grid grid-cols-2 gap-3 text-center">
          ...
          <div className="bg-zinc-900/50 p-2.5 rounded-xl border border-zinc-855 relative overflow-hidden">
            ...
            <span className="text-[9px] text-cyan-400 font-bold uppercase tracking-wide block">
              Output f(x)
            </span>
